...
class Plugin {
    ...
    public function load_textdomain(): void {
        load_plugin_textdomain( 'ago-maintenance', false, dirname( plugin_basename( AGO_MAINTENANCE_FILE ) ) . '/languages' );
    }
    ...
    public function register_rest_routes(): void {
        register_rest_route( 'ago-maintenance/v1', '/settings', [
            [
                'methods'             => 'GET',
    ...
    public function handle_save_settings( \WP_REST_Request $request ): \WP_REST_Response {
        ...
        update_option( 'ago_maintenance_settings', $settings );
    ...
    public function enqueue_assets( string $hook ): void {
        if ( ! str_ends_with( $hook, '_page_ago-maintenance' ) ) {
            return;
        }
        ...
        wp_enqueue_style(
            'ago-maintenance-admin',
            AGO_MAINTENANCE_URL . 'assets/css/admin.css',
            [],
            AGO_MAINTENANCE_VERSION
        );

        wp_enqueue_script(
            'ago-maintenance-admin',
            AGO_MAINTENANCE_URL . 'assets/js/admin.js',
            [],
            AGO_MAINTENANCE_VERSION,
            true
        );

        wp_localize_script( 'ago-maintenance-admin', 'agoMaintenance', [
            'restUrl'  => rest_url( 'ago-maintenance/v1' ),
    ...
    public static function get_settings(): array {
        $saved = get_option( 'ago_maintenance_settings', [] );
